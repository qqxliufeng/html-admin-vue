...
const goodsInfoRefundFormData = {
  ...
  over: 0,
  overDay: 0,
  overTimeTemp: new Date(refundCurrentDay.getFullYear(), refundCurrentDay.getMonth(), refundCurrentDay.getDate(), 23, 59),
  overTime: 0,
  expire_charge_way: 0,
  ...
  initData (tempData) {
    ...
    this.overTimeTemp = tempData.overTimeTemp
