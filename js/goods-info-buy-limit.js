 ...
 * @LastEditTime: 2020-05-29 16:15:46
...
const goodsInfoBuyLimitFormData = {
  ...
  beforeMinute: 0,
  beforeDay: 0,
  beforeTimeTemp: new Date(buyLimitCurrentDay.getFullYear(), buyLimitCurrentDay.getMonth(), buyLimitCurrentDay.getDate(), 23, 59),
  beforeTime: 0,
  is_custom: 0,
  tagsTemp: [],
  tags: '',
  ...
  initData (tempData) {
    ...
    this.beforeTimeTemp = tempData.beforeTimeTemp
    this.is_custom = tempData.is_custom
    this.tags = tempData.tags
