 ...
 * @LastEditTime: 2020-05-29 15:46:25
...
const goodsInfoVerifyFormData = {
  ...
  initData (tempData) {
    ...
    this.validPeriodRange[0] = tempData.valid_period_start
    this.validPeriodRange[1] = tempData.valid_period_end
    this.valid_period_week = tempData.valid_period_week
    this.sendCode = tempData.sendCode

    this.checkRules = tempData.checkRules
    this.lowCheckNum = tempData.lowCheckNum
  }
}
