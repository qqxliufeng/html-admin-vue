 ...
 * @LastEditTime: 2020-05-30 17:26:34
...
const goodsInfoEnterFormData = {
  ...
  parkProve: '',
  other_way: '',
  checkTimeRange: [new Date(enterCurrentDay.getFullYear(), enterCurrentDay.getMonth() + 1, enterCurrentDay.getDate(), 8, 00), new Date(enterCurrentDay.getFullYear(), enterCurrentDay.getMonth() + 1, enterCurrentDay.getDate(), 15, 00)],
  ...
  initData (tempData) {
    ...
    this.touristsInfoTemp = tempData.touristsInfoTemp
    this.is_id_number = tempData.is_id_number
    this.id_card_rule = tempData.id_card_rule
    this.parkWays = tempData.parkWays
    this.parkProveTemp = tempData.parkProveTemp

    this.other_way = tempData.other_way

    this.checkTimeRange = []
    const startTime = new Date(tempData.parkCheckStartTime * 1000)
    this.checkTimeRange.push(new Date(startTime.getFullYear(), startTime.getMonth() + 1, startTime.getDate(), startTime.getHours(), startTime.getMinutes()))

    const endTime = new Date(tempData.parkCheckEndTime * 1000)
    this.checkTimeRange.push(new Date(endTime.getFullYear(), endTime.getMonth() + 1, endTime.getDate(), endTime.getHours(), endTime.getMinutes()))
